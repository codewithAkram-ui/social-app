...
const  SocialSciencesandhumanities= () => {
    ...
    const fetchCommunities = async () => {
      ...
      try {
        const snapshot = await firestore()
          ...
          .doc('Social Science and Humanities')
  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <TouchableOpacity onPress={() => navigation.goBack()}>
        ...
        <Text style={styles.title}>Humanities & Social</Text>
      </View>
...
export default  SocialSciencesandhumanities;
